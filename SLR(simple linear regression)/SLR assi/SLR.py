...
calory_data = pd.read_csv("F:/assignment/SLR(simple linear regression)/SLR assi/datasets/calories_consumed.csv")
...
delivery_data = pd.read_csv("F:/assignment/SLR(simple linear regression)/SLR assi/datasets/delivery_time.csv")
...
emp_data = pd.read_csv("F:/assignment/SLR(simple linear regression)/SLR assi/datasets/emp_data.csv")
...
salary_data = pd.read_csv("F:/assignment/SLR(simple linear regression)/SLR assi/datasets/Salary_Data.csv")
...
sat_data = pd.read_csv("F:/assignment/SLR(simple linear regression)/SLR assi/datasets/SAT_GPA.csv")
