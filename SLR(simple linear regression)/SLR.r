...
library(readr)
#Loading dataset
calory_data <- read.csv("C:\\Users\\hp\\Desktop\\SLR assi\\calories_consumed.csv" , header = T)
...
library(Hmisc)
describe(calory_data)

# Graphical exploration
install.packages("lattice")
library("lattice")
dotplot(calory_data$Weight.gained..grams., main = "Dot Plot of weight gained (grams)")
dotplot(calory_data$Calories.Consumed, main = "Dot Plot of Calories consumed")

boxplot(calory_data$Weight.gained..grams., col = "dodgerblue4")
boxplot(calory_data$Calories.Consumed, col = "red", horizontal = T)

hist(calory_data$Weight.gained..grams.)
hist(calory_data$Calories.Consumed)

# Normal QQ plot
qqnorm(calory_data$Weight.gained..grams.)
qqline(calory_data$Weight.gained..grams.)

qqnorm(calory_data$Calories.Consumed)
qqline(calory_data$Calories.Consumed)

hist(calory_data$Weight.gained..grams., prob = TRUE)          # prob=TRUE for probabilities not counts
lines(density(calory_data$Weight.gained..grams.))             # add a density estimate with defaults
lines(density(calory_data$Weight.gained..grams., adjust = 2), lty = "dotted")   # add another "smoother" density

hist(calory_data$Calories.Consumed, prob = TRUE)          # prob=TRUE for probabilities not counts
lines(density(calory_data$Calories.Consumed))             # add a density estimate with defaults
lines(density(calory_data$Calories.Consumed, adjust = 2), lty = "dotted")   # add another "smoother" density

# Bivariate analysis
# Scatter plot
plot(calory_data$Weight.gained..grams., calory_data$Calories.Consumed, main = "Scatter Plot", col = "Dodgerblue4", 
...
plot(calory_data$Weight.gained..grams., calory_data$Calories.Consumed)
...
reg <- lm(Calories.Consumed ~ ., data = calory_data) # Y ~ X
summary(reg)
...
ggplot(data = calory_data, aes(Weight.gained..grams., Calories.Consumed) ) +
  geom_point() + stat_smooth(method = lm, formula = y ~ x)

# Alternate way
ggplot(data = calory_data, aes(x = Weight.gained..grams., y = Calories.Consumed)) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = calory_data, aes(x = Weight.gained..grams., y = pred$fit))

# Evaluation the model for fitness 
cor(pred$fit, calory_data$Calories.Consumed)
...
reg_log <- lm(Calories.Consumed ~ log(Weight.gained..grams.), data = calory_data)
summary(reg_log)
...
ggplot(data = calory_data, aes(log(Weight.gained..grams.), Calories.Consumed) ) +
  geom_point() + stat_smooth(method = lm, formula = y ~ log(x))

# Alternate way
ggplot(data = calory_data, aes(x = log(Weight.gained..grams.), y = Calories.Consumed)) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = calory_data, aes(x = log(Weight.gained..grams.), y = pred$fit))
...
reg_log1 <- lm(log(Calories.Consumed) ~ Weight.gained..grams., data = calory_data)
summary(reg_log1)
...
# Regression line for data
ggplot(data = calory_data, aes(Weight.gained..grams., log(Calories.Consumed)) ) +
  geom_point() + stat_smooth(method = lm, formula = log(y) ~ x)

# Alternate way
ggplot(data = calory_data, aes(x = Weight.gained..grams., y = log(Calories.Consumed))) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = calory_data, aes(x = Weight.gained..grams., y = predlog$fit))


# Non-linear models = Polynomial models
# input = x & x^2 (2-degree) and output = log(y)
reg2 <- lm(log(Calories.Consumed) ~ Weight.gained..grams. + I(Weight.gained..grams.*Weight.gained..grams.), data = calory_data)
summary(reg2)
...
# Alternate way
ggplot(data = calory_data, aes(x = Weight.gained..grams. + I(Weight.gained..grams.*Weight.gained..grams.), y = log(Calories.Consumed))) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = calory_data, aes(x = Weight.gained..grams. + I(Weight.gained..grams.^2), y = pred$fit))
...
library(readr)
#Loading dataset
delivery_data <- read.csv("C:\\Users\\hp\\Desktop\\SLR assi\\delivery_time.csv" , header = T)
...
# Linear Regression model
reg <- lm(Delivery.Time ~ ., data = delivery_data) # Y ~ X
summary(reg)
...
# Alternate way
ggplot(data = delivery_data, aes(x = Sorting.Time, y = Delivery.Time)) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = delivery_data, aes(x = Sorting.Time, y = pred$fit))
...
# Alternate way
ggplot(data = delivery_data, aes(x = log(Sorting.Time), y = Delivery.Time)) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = delivery_data, aes(x = log(Sorting.Time), y = pred$fit))
...
# Alternate way
ggplot(data = delivery_data, aes(x = Sorting.Time, y = log(Delivery.Time))) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = delivery_data, aes(x = Sorting.Time, y = predlog$fit))
...
# Alternate way
ggplot(data = delivery_data, aes(x = Sorting.Time + I(Sorting.Time*Sorting.Time), y = log(Delivery.Time))) + 
  geom_point(color = 'blue') +
  geom_line(color = 'red', data = delivery_data, aes(x = Sorting.Time + I(Sorting.Time^2), y = pred$fit))
...
library(readr)
#Loading dataset
emp_data <- read.csv("C:\\Users\\hp\\Desktop\\SLR assi\\emp_data.csv" , header = T)
...
library(readr)
#Loading dataset
salary_data <- read.csv("C:\\Users\\hp\\Desktop\\SLR assi\\Salary_Data.csv" , header = T)
...
library(readr)
#Loading dataset
sat_data <- read.csv("C:\\Users\\hp\\Desktop\\SLR assi\\SAT_GPA.csv" , header = T)
